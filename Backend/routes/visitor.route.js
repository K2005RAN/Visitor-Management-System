...
import {
  ...
  visitorOut,
  getVisitorLogs,
  getDailyGroupedLogs, // 🟢 1. Imported from your existing InOut controller
...
router.get("/logs", getVisitorLogs); // 🟢 2. CHANGED: Now points to the clean deduplicated pipeline!
